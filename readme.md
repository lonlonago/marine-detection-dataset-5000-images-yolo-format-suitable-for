# Marine Detection Dataset 5000 Images YOLO Format Suitable for

# Body

Marine Detection Dataset, 5000 Images in YOLO format， suitable for training models of marine target detection, clear images, complete annotations, ready to use, worry-free
